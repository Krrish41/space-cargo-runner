        ...
        <div style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center' }} className="center-stage">
          ...
          {gameState === 'MENU' && (
             <div className="menu-screen" style={{ textAlign: 'center', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
               ...
               {/* LIVE COMMS TICKER */}
               <div className="live-comms-ticker" style={{ marginTop: '40px', display: 'flex', flexDirection: 'column', border: '1px solid rgba(0, 255, 204, 0.3)', padding: '5px', background: 'rgba(5, 5, 10, 0.85)', backdropFilter: 'blur(4px)', color: '#00ffcc', fontFamily: 'monospace', width: '100%', maxWidth: '600px', height: '140px', borderRadius: '8px', boxShadow: '0 4px 15px rgba(0,0,0,0.5), inset 0 0 20px rgba(0,255,204,0.05)' }}>
