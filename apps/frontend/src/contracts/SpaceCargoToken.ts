/**
 * SpaceCargoToken Contract ABI and Address
 * 
 * This file exports the contract configuration for the SCR (Space Cargo Runner) token
 * deployed on the SecureChain (SCAI) network.
 * 
 * After deploying the contract, update the CONTRACT_ADDRESS below.
 */
